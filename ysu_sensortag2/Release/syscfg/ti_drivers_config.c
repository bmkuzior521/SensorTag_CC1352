...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* ADXL343_CS */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* BME_CS */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* AD5941_CS */
    ...
    /* Owned by CONFIG_SPI_0 as SS */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_SPI_0_SS */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* RGB_Blue */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* RGB_Red */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* RGB_Green */
...
const uint_least8_t BME_CS_CONST = BME_CS;
const uint_least8_t ADXL343_CS_CONST = ADXL343_CS;
const uint_least8_t RGB_Red_CONST = RGB_Red;
const uint_least8_t RGB_Blue_CONST = RGB_Blue;
const uint_least8_t RGB_Green_CONST = RGB_Green;
const uint_least8_t AD5941_CS_CONST = AD5941_CS;
...
const uint_least8_t CONFIG_GPIO_SPI_0_SS_CONST = CONFIG_GPIO_SPI_0_SS;
